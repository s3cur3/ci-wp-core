...
function ciRegisterRequiredPlugins() {
     ...
     */
    $config = array(
        'domain'       		=> 'ci-modern-accounting-firm',         	// Text domain - likely want to be the same as your theme.
        ...
        'strings'      		=> array(
            ...
            'installing'                       			=> __( 'Installing Plugin: %s', 'ci-modern-accounting-firm' ), // %1$s = plugin name
            'oops'                             			=> __( 'Something went wrong with the plugin API.', 'ci-modern-accounting-firm' ),
            'notice_can_install_required'     			=> _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'ci-modern-accounting-firm' ), // %1$s = plugin name(s)
            'notice_can_install_recommended'			=> _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'ci-modern-accounting-firm' ), // %1$s = plugin name(s)
            'notice_cannot_install'  					=> _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'ci-modern-accounting-firm' ), // %1$s = plugin name(s)
            'notice_can_activate_required'    			=> _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'ci-modern-accounting-firm' ), // %1$s = plugin name(s)
            'notice_can_activate_recommended'			=> _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'ci-modern-accounting-firm' ), // %1$s = plugin name(s)
            ...
            'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'ci-modern-accounting-firm' ), // %1$s = dashboard link
